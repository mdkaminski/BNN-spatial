...
class BayesNet:
    ...
    def sample_multi_chains(self, x_train, y_train, num_samples,
        ...
        sampling_configs = {
            ...
            "mdecay": mdecay, "print_every_n_samples": print_every_n_samples, "num_cycles": num_cycles,
            "resample_prior_every": resample_prior_every, "num_iterations": num_iterations, "lr": lr,
            "exploration_prop": exploration_prop
        }
